...
<body>
   ...
   data-item-name="20,000mAh Dual-Port Power Bank" 
            ...
            <div class="showcase-right-column">
                <section class="showcase-promo-card showcase-card-top"
                    ...
                    <div class="showcase-content">
                        ...
                        <p>₱1,500.00</p>
                        <div class="showcase-buttons">
                            <a class="buy-btn buy-now-btn" href="#" data-item-name="Heavy-Duty Jumper Cables (8-Gauge)" data-item-price="1500.00">Buy Now</a>
                            <a class="add-cart-btn" href="#">Add to Cart</a>
                        </div>
                    </div>
                </section>
                <section class="showcase-promo-card showcase-card-bottom"
                    ...
                    <div class="showcase-content">
                        ...
                        <p>₱1,250.00</p>
                        <div class="showcase-buttons">
                            <a class="buy-btn buy-now-btn" href="#" data-item-name="Smart Surge Protector Power Strip" data-item-price="1250.00">Buy Now</a>
                            <a class="add-cart-btn" href="#">Add to Cart</a>
                        </div>
                    </div>
                </section>
        ...
        <section class="products" id="new-arrivals-grid">
            <div class="product-card" style="background-image: url('assets/img/electronics/multimeter.png')">
                <div class="product-content">
                    ...
                    <div class="product-buttons">
                        <a class="buy-btn buy-now-btn" href="#" data-item-name="Digital Multimeter" data-item-price="950.00">Buy Now</a>
                        <a class="add-cart-btn" href="#">Add to Cart</a>
                    </div>
                </div>
            </div>
            <div class="product-card" style="background-image: url('assets/img/electronics/led.png')">
                <div class="product-content">
                    ...
                    <p>₱850.00</p>
                    <div class="product-buttons">
                        <a class="buy-btn buy-now-btn" href="#" data-item-name="Rechargeable LED Headlamp" data-item-price="850.00">Buy Now</a>
                        <a class="add-cart-btn" href="#">Add to Cart</a>
                    </div>
                </div>
            </div>
            <div class="product-card" style="background-image: url('assets/img/electronics/circuit.png')">
                <div class="product-content">
                    ...
                    <p>₱450.00</p>
                    <div class="product-buttons">
                        <a class="buy-btn buy-now-btn" href="#" data-item-name="Automatic Circuit Breaker (20A)" data-item-price="450.00">Buy Now</a>
                        <a class="add-cart-btn" href="#">Add to Cart</a>
                    </div>
                </div>
            </div>
            <div class="product-card" style="background-image: url('assets/img/electronics/lithium.png')">
                <div class="product-content">
                    ...
                    <p>₱350.00</p>
                    <div class="product-buttons">
                        <a class="buy-btn buy-now-btn" href="#" data-item-name="CR2032 Lithium Coin Batteries (10-Pack)" data-item-price="350.00">Buy Now</a>
                        <a class="add-cart-btn" href="#">Add to Cart</a>
                    </div>
                </div>
            </div>
        ...
        <section class="products" id="top-sellers-grid">
            <div class="product-card" style="background-image: url('assets/img/electronics/aa.png')">
                <div class="product-content">
                    ...
                    <p>₱750.00</p>
                    <div class="product-buttons">
                        <a class="buy-btn buy-now-btn" href="#" data-item-name="AA Alkaline Batteries (24-Pack)" data-item-price="750.00">Buy Now</a>
                        <a class="add-cart-btn" href="#">Add to Cart</a>
                    </div>
                </div>
            </div>
            <div class="product-card" style="background-image: url('assets/img/electronics/aaa.png')">
                <div class="product-content">
                    ...
                    <p>₱750.00</p>
                    <div class="product-buttons">
                        <a class="buy-btn buy-now-btn" href="#" data-item-name="AAA Alkaline Batteries (24-Pack)" data-item-price="750.00">Buy Now</a>
                        <a class="add-cart-btn" href="#">Add to Cart</a>
                    </div>
                </div>
            </div>
            <div class="product-card" style="background-image: url('assets/img/electronics/slimpower.png')">
                <div class="product-content">
                    ...
                    <p>₱1,200.00</p>
                    <div class="product-buttons">
                        <a class="buy-btn buy-now-btn" href="#" data-item-name="10,000mAh Slim Power Bank" data-item-price="1200.00">Buy Now</a>
                        <a class="add-cart-btn" href="#">Add to Cart</a>
                    </div>
                </div>
            </div>
            <div class="product-card" style="background-image: url('assets/img/electronics/extension.png')">
                <div class="product-content">
                    ...
                    <p>₱900.00</p>
                    <div class="product-buttons">
                        <a class="buy-btn buy-now-btn" href="#" data-item-name="Heavy-Duty Extension Cord (10-meter)" data-item-price="900.00">Buy Now</a>
                        <a class="add-cart-btn" href="#">Add to Cart</a>
                    </div>
                </div>
            </div>
            <div class="product-card" style="background-image: url('assets/img/electronics/ledflash.png')">
                <div class="product-content">
                    ...
                    <p>₱1,100.00</p>
                    <div class="product-buttons">
                        <a class="buy-btn buy-now-btn" href="#" data-item-name="Rechargeable LED Flashlight" data-item-price="1100.00">Buy Now</a>
                        <a class="add-cart-btn" href="#">Add to Cart</a>
                    </div>
                </div>
            </div>
            <div class="product-card" style="background-image: url('assets/img/electronics/9v.png')">
                <div class="product-content">
                    ...
                    <p>₱550.00</p>
                    <div class="product-buttons">
                        <a class="buy-btn buy-now-btn" href="#" data-item-name="9V Alkaline Batteries (4-Pack)" data-item-price="550.00">Buy Now</a>
                        <a class="add-cart-btn" href="#">Add to Cart</a>
                    </div>
                </div>
            </div>
            <div class="product-card" style="background-image: url('assets/img/electronics/alligator.png')">
                <div class="product-content">
                    ...
                    <p>₱300.00</p>
                    <div class="product-buttons">
                        <a class="buy-btn buy-now-btn" href="#" data-item-name="Alligator Clip Jumper Wires (Set of 10)" data-item-price="300.00">Buy Now</a>
                        <a class="add-cart-btn" href="#">Add to Cart</a>
                    </div>
                </div>
            </div>
            <div class="product-card" style="background-image: url('assets/img/electronics/emergency.png')">
                <div class="product-content">
                    ...
                    <p>₱950.00</p>
                    <div class="product-buttons">
                        <a class="buy-btn buy-now-btn" href="#" data-item-name="LED Emergency Light with Battery Backup" data-item-price="950.00">Buy Now</a>
                        <a class="add-cart-btn" href="#">Add to Cart</a>
                    </div>
                </div>
            </div>
