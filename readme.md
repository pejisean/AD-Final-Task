...
The Last Trade Post is a post-apocalyptic online marketplace where survivors can barter, buy, and sell essential goods. Built with PHP, JavaScript, and PostgreSQL, it features secure authentication, inventory management, and a user-friendly interface to help users connect and trade for survival.
...
| Copilot      | 	Assisted with code structure, PHP and JS logic implementation, and troubleshooting. | https://chatgpt.com/           |
| Deepseek     | 	Provided template references and helped optimize CSS animations.                    | https://www.deepseek.com/      |
| Youtube      |  Php, js, and css tutorials. Tips and Tricks.                                        | https://www.youtube.com/       |
